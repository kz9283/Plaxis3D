...
class GeometryView(Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Label(self.heading, text='Operation Mode    |', width=18).grid(row=0, column=0)
        Label(self.heading, text=' Length L (m)    |', width=15).grid(row=0, column=1)
        Label(self.heading, text='  Width B (m)', width=15).grid(row=0, column=2)
        self.heading.pack()
